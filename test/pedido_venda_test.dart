...
void main() {
  test('Should calculate totals correctly and generate XML', () {
    ...
    expect(xml, contains('pac00_pactot="90.000"'));
    expect(xml, contains('pac00_clicod="36109"'));
    expect(xml, contains('pac00_bontot="30.000"'));
    expect(xml, contains('pac00_destot="10.000"'));
    expect(xml, contains('pac00_subtot="100.000"'));
    expect(xml, contains('pac00_digtot="90.000"'));
    ...
    expect(xml, contains('pac01_qtd="2.000"'));
    expect(xml, contains('pac01_pco="50.000"'));
    expect(xml, contains('pac01_pcomax="60.000"'));
    expect(xml, contains('pac01_pcomin="40.000"'));
