...
class _PedidoItensListaWidgetState extends State<PedidoItensListaWidget> {
  ...
  /// Atualiza a quantidade do item diretamente a partir da edição inline no card do pedido.
  Future<void> _atualizarQuantidadeDireta(ItemPedidoStruct item, double novaQuantidade) async {
    if (_isEdicaoBloqueada()) return;

    final int quantidade = novaQuantidade.toInt();
    if (quantidade <= 0) {
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ItemPedidoCardWidget(
                            ...
                            onAlterarQuantidade: (novaQtd) => _atualizarQuantidadeDireta(item, novaQtd),
                          );
                        },
                      ),
              ),
